...
public class SeguimientoComprasController {
    ...
    private void buscarOC() {
        ...
        Rubro rubro = (codigoRubro != null) ? RubroController.buscarRubro(codigoRubro) : null;
        ...
        for (OrdenDeCompra oc : OrdenDeCompraController.buscarOrdenesDeCompra(estado, rubro, proveedor)) {
    ...
    private void buscarPagos() {
        ...
        for (OrdenDePago op : OrdenDePagoController.buscarOrdenesDePago(desde, hasta, tipoMedio, proveedor)) {
    ...
    private void cargarCombos() {
        ...
        for (Rubro r : RubroController.getRubros()) {
